...
describe('defaultNudgeActions', () => {
  ...
  it('nudge.left.big gestureBinding = ArrowLeft, shift:true', () => {
  ...
  it('all nudge actions have a key-spec gestureBinding', () => {
    const acts = defaultNudgeActions(makeDeps());
