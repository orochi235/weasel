...
import { createCreateGroupOp } from '../../../ops/createGroup';
import { createDissolveGroupOp } from '../../../ops/dissolveGroup';
...
/** Options for `useGroupAction`. */
export interface UseGroupActionOptions {
...
/** Return shape of `useGroupAction`. */
export interface UseGroupActionReturn {
...
/** Options for `useUngroupAction`. */
export interface UseUngroupActionOptions {
...
/** Return shape of `useUngroupAction`. */
export interface UseUngroupActionReturn {
...
export function useUngroupAction(
  adapter: GroupActionAdapter,
  options: UseUngroupActionOptions = {},
