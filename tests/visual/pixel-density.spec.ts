/**
 * Visual regression spec: pixel-density demo.
 *
 ...
 *
 * Notes: Static pixel-density demo. Demo exists specifically to test DPR behavior; tolerance bumped to 5%.
 */
import { test } from '@playwright/test';
import { resolve } from 'node:path';
import { captureCanvas, assertMatchesBaseline, type DiffOptions } from './diff.js';

const DEMO_ID = 'pixel-density';
