...
- One-off lab page with custom rendering? Import primitives directly from `@orochi235/labkit`.
...
| Weasel-ui passthroughs (`CurveEditor`, `useReorderDragList`, `formatNumber`, …) | `src/passthrough/weasel-ui.ts` (exported as `@orochi235/labkit/weasel-ui`) |
