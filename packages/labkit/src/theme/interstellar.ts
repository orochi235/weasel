import { defineTheme, weaselTheme, type Theme, type ThemeInput } from '@weasel-js/theme';
 ...
 */
export const interstellarTheme: Theme = defineTheme({ ...definition, extends: weaselTheme } as ThemeInput);
