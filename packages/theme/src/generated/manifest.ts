...
export const TOKEN_MANIFEST: readonly TokenManifestEntry[] = [
  ...
  { name: '--wzl-property-readout-w', type: "dimension", group: "property", defaultValue: "0px", description: "Minimum width of a Properties row’s value readout, which is otherwise sized to the widest value its range can show.", hook: true },
