...
export const TOKEN_MANIFEST: readonly TokenManifestEntry[] = [
  ...
  { name: '--wzl-panel-scope-border-width', type: "dimension", group: "panel", defaultValue: "0", description: "", hook: false },
  { name: '--wzl-panel-scope-radius', type: "dimension", group: "panel", defaultValue: "8px", description: "", hook: false },
  { name: '--wzl-panel-scope-tone-mix', type: "number", group: "panel", defaultValue: "22%", description: "", hook: false },
  { name: '--wzl-panel-scope-nested-radius', type: "dimension", group: "panel", defaultValue: "6px", description: "", hook: false },
  { name: '--wzl-panel-scope-nested-surface', type: "color", group: "panel", defaultValue: "#181a1e", description: "A scope panel inside another sits back into it.", hook: false },
  { name: '--wzl-panel-aside-surface', type: "color", group: "panel", defaultValue: "transparent", description: "", hook: false },
  { name: '--wzl-panel-aside-border-color', type: "color", group: "panel", defaultValue: "rgba(230, 231, 233, 0.1)", description: "", hook: false },
  { name: '--wzl-panel-aside-blur', type: "dimension", group: "panel", defaultValue: "0px", description: "", hook: false },
  { name: '--wzl-panel-aside-title-color', type: "color", group: "panel", defaultValue: "#6f737b", description: "", hook: false },
  { name: '--wzl-panel-advanced-title-color', type: "color", group: "panel", defaultValue: "#6f737b", description: "", hook: false },
  { name: '--wzl-panel-debug-border-style', type: "string", group: "panel", defaultValue: "dashed", description: "", hook: false },
  { name: '--wzl-panel-debug-title-font', type: "fontFamily", group: "panel", defaultValue: "ui-monospace, SFMono-Regular, Menlo, Consolas, monospace", description: "", hook: false },
  { name: '--wzl-panel-debug-title-case', type: "string", group: "panel", defaultValue: "none", description: "", hook: false },
  { name: '--wzl-panel-danger-tone', type: "color", group: "panel", defaultValue: "#d94a3f", description: "", hook: false },
  { name: '--wzl-panel-danger-border-color', type: "color", group: "panel", defaultValue: "#d94a3f", description: "", hook: false },
  { name: '--wzl-panel-danger-title-color', type: "color", group: "panel", defaultValue: "#d94a3f", description: "", hook: false },
  { name: '--wzl-panel-notice-tone', type: "color", group: "panel", defaultValue: "#2e1f7a", description: "", hook: false },
  { name: '--wzl-panel-notice-tone-mix', type: "number", group: "panel", defaultValue: "8%", description: "", hook: false },
  { name: '--wzl-panel-important-border-color', type: "color", group: "panel", defaultValue: "#5841b8", description: "", hook: false },
  { name: '--wzl-panel-important-title-color', type: "color", group: "panel", defaultValue: "#5841b8", description: "", hook: false },
  { name: '--wzl-panel-preview-pad', type: "dimension", group: "panel", defaultValue: "0", description: "", hook: false },
  { name: '--wzl-panel-preview-title-size', type: "dimension", group: "panel", defaultValue: "10px", description: "", hook: false },
  { name: '--wzl-panel-preview-title-case', type: "string", group: "panel", defaultValue: "none", description: "", hook: false },
  { name: '--wzl-panel-preview-title-inset', type: "dimension", group: "panel", defaultValue: "6px 10px 0", description: "", hook: false },
