...
export const TOKEN_MANIFEST: readonly TokenManifestEntry[] = [
  ...
  { name: '--wzl-slider-track-tint', type: "dimension", group: "slider", defaultValue: "18%", description: "Accent proportion in a range track. Mixed into a real property, never into another custom property." },
  { name: '--wzl-slider-thumb-tint', type: "dimension", group: "slider", defaultValue: "70%", description: "Accent proportion in a range thumb." },
