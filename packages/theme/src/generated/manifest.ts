...
export const TOKEN_MANIFEST: readonly TokenManifestEntry[] = [
  ...
  { name: '--wzl-font-size-2xs', type: "dimension", group: "font", defaultValue: "9px", description: "Shortcut keys and index badges. Below this a glyph stops resolving at 1x." },
  ...
  { name: '--wzl-font-size-xl', type: "dimension", group: "font", defaultValue: "20px", description: "The lab title. Replaces labkit's local --lk-title-size." },
  ...
  { name: '--wzl-line-height-tight', type: "number", group: "line", defaultValue: "1", description: "Single-line controls; the box sets the height." },
  { name: '--wzl-line-height-snug', type: "number", group: "line", defaultValue: "1.2", description: "Headings and two-line labels." },
  { name: '--wzl-line-height', type: "number", group: "line", defaultValue: "1.4", description: "Body and anything that wraps." },
  ...
  { name: '--wzl-font-ui', type: "fontFamily", group: "font", defaultValue: "Oswald, 'Helvetica Neue Condensed', 'Arial Narrow', system-ui, sans-serif", description: "Condensed UI/display face." },
  ...
  { name: '--wzl-font-weight-medium', type: "fontWeight", group: "font", defaultValue: "500", description: "" },
  { name: '--wzl-font-weight-bold', type: "fontWeight", group: "font", defaultValue: "700", description: "" },
