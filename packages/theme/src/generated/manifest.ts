...
export const TOKEN_MANIFEST: readonly TokenManifestEntry[] = [
  ...
  { name: '--wzl-swatch-green', type: "color", group: "swatch", defaultValue: "#48e628", description: "" },
  { name: '--wzl-swatch-sky', type: "color", group: "swatch", defaultValue: "#36bff2", description: "" },
  { name: '--wzl-swatch-amber', type: "color", group: "swatch", defaultValue: "#e69628", description: "" },
  { name: '--wzl-swatch-teal', type: "color", group: "swatch", defaultValue: "#3ee1cb", description: "" },
  { name: '--wzl-swatch-red', type: "color", group: "swatch", defaultValue: "#f75034", description: "" },
  { name: '--wzl-swatch-blue', type: "color", group: "swatch", defaultValue: "#407ef7", description: "" },
  { name: '--wzl-swatch-citron', type: "color", group: "swatch", defaultValue: "#d5d23a", description: "" },
  { name: '--wzl-swatch-rose', type: "color", group: "swatch", defaultValue: "#fa4590", description: "" },
  { name: '--wzl-swatch-violet', type: "color", group: "swatch", defaultValue: "#955cf9", description: "" },
  ...
  { name: '--wzl-border-strong', type: "color", group: "border", defaultValue: "#6f737b", description: "The line that has to be seen: a control's edge, a raised surface's outline. Clears WCAG 1.4.11's 3:1 against every surface in both modes." },
  ...
  { name: '--wzl-slider-track-h', type: "dimension", group: "slider", defaultValue: "4px", description: "Height of a linear range track. The kit's single-thumb ranges all wear this; Slider's default 24px canvas track does not." },
  { name: '--wzl-slider-thumb-size', type: "dimension", group: "slider", defaultValue: "8px", description: "Diameter of a linear range thumb." },
  { name: '--wzl-slider-track-mix', type: "dimension", group: "slider", defaultValue: "18%", description: "Accent proportion in a range track, as a color-mix percentage — not a color. Mixed into a real property, never into another custom property." },
  { name: '--wzl-slider-thumb-mix', type: "dimension", group: "slider", defaultValue: "70%", description: "Accent proportion in a range thumb, as a color-mix percentage — not a color." },
  { name: '--wzl-handle-size', type: "dimension", group: "handle", defaultValue: "9px", description: "Edge of a draggable handle on a plot or timeline — a keyframe diamond, a timeline key, an event mark. The default rank; -sm and -lg are the two deliberate departures from it." },
  { name: '--wzl-handle-size-sm', type: "dimension", group: "handle", defaultValue: "7px", description: "A handle that is drawn but not draggable — a locked or pinned point. Smaller so it reads as inert next to a live one." },
  { name: '--wzl-handle-size-lg', type: "dimension", group: "handle", defaultValue: "10px", description: "A handle that is a category of its own rather than one of a row — a curve's endpoint. Larger so it separates from the handles it sits in line with." },
  { name: '--wzl-field-pad-x', type: "dimension", group: "field", defaultValue: "8px", description: "Horizontal padding inside a boxed field. Pairs with --wzl-field-h, which is a container override and has no :root default." },
  ...
  { name: '--wzl-font-size-2xs', type: "dimension", group: "font", defaultValue: "9px", description: "Shortcut keys and index badges. The floor for chrome text." },
  { name: '--wzl-font-size-xs', type: "dimension", group: "font", defaultValue: "10px", description: "Tool-button labels under an icon." },
  { name: '--wzl-font-size-sm', type: "dimension", group: "font", defaultValue: "11px", description: "Chrome labels, status readouts, section headings." },
  { name: '--wzl-font-size', type: "dimension", group: "font", defaultValue: "13px", description: "Controls and body text." },
  { name: '--wzl-font-size-lg', type: "dimension", group: "font", defaultValue: "16px", description: "Panel and dialog titles." },
  { name: '--wzl-font-size-xl', type: "dimension", group: "font", defaultValue: "20px", description: "The largest chrome text — a lab or app title." },
  ...
  { name: '--wzl-leading-tight', type: "number", group: "leading", defaultValue: "1", description: "Single-line controls; the box sets the height." },
  { name: '--wzl-leading-snug', type: "number", group: "leading", defaultValue: "1.2", description: "Headings and two-line labels." },
  { name: '--wzl-leading', type: "number", group: "leading", defaultValue: "1.4", description: "Body and anything that wraps." },
