...
- Op coalescing in `useScene` — done 2026-07-25; serialization follow-up shipped 2026-07-25; Phase 2b (OS clipboard) pending → [Selection, actions & UI panels](#selection-actions--ui-panels)
