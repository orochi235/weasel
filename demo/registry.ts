...
export const DEMOS: DemoEntry[] = [
  ...
  },
  {
    ...
    title: 'Actions',
    category: 'Selection & actions',
    description: 'Four selection-driven action hooks — useEscape, useSelectAll, useDuplicate, useNudge — wired with their default keybindings. Click the canvas to focus, then try the shortcuts.',
